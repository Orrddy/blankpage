...
<body class="font-sans bg-gray-50 text-gray-900">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <footer class="py-4" style="background:#12111C;border-top:1px solid rgba(212,175,55,0.15);">
            <div class="container mx-auto px-4 text-center">
                <div style="display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:8px;">
                    <img src="/images/amhsrc-logo.svg" alt="AMHSRC" style="height:22px;width:22px;opacity:0.8;">
                    <span style="font-family:'Inter',sans-serif;font-size:12px;font-weight:700;color:rgba(255,255,255,0.6);letter-spacing:0.08em;">AMHSRC</span>
                    <span style="font-family:'Noto Serif SC',serif;font-size:10px;color:rgba(212,175,55,0.5);">国际商业银行</span>
                </div>
                <p style="font-size:11px;color:rgba(255,255,255,0.3);">&copy; {{ date('Y') }} AMHSRC International Commercial Bank &nbsp;&middot;&nbsp; amhsrc.com</p>
                <div style="margin-top:8px;display:flex;justify-content:center;gap:16px;">
                    <a href="#" style="font-size:11px;color:rgba(255,255,255,0.3);text-decoration:none;" onmouseover="this.style.color='#D4AF37'" onmouseout="this.style.color='rgba(255,255,255,0.3)'">Privacy Policy</a>
                    <a href="#" style="font-size:11px;color:rgba(255,255,255,0.3);text-decoration:none;" onmouseover="this.style.color='#D4AF37'" onmouseout="this.style.color='rgba(255,255,255,0.3)'">Terms of Service</a>
                    <a href="#" style="font-size:11px;color:rgba(255,255,255,0.3);text-decoration:none;" onmouseover="this.style.color='#D4AF37'" onmouseout="this.style.color='rgba(255,255,255,0.3)'">Contact Support</a>
                </div>
            </div>
        </footer>
    </div>
