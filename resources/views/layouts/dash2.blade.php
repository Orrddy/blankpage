...
<head>
    ...
    <!-- AMHSRC: Lock Chinese Bank colors — overrides DB injection above -->
    <script>
        // Re-declare our brand colors immediately after DB variables are set.
        // This ensures no database appearance setting can overwrite our theme.
        (function lockAMHSRCTheme() {
            var root = document.documentElement;
            root.style.setProperty('--primary-color',          '#C8102E');
            root.style.setProperty('--primary-color-dark',     '#9A0B22');
            root.style.setProperty('--primary-color-light',    '#E8405A');
            root.style.setProperty('--primary-color-lightest', '#F9E5E8');
            root.style.setProperty('--secondary-color',        '#D4AF37');
            root.style.setProperty('--secondary-color-dark',   '#A8892A');
            root.style.setProperty('--secondary-color-light',  '#E8CC6A');
            root.style.setProperty('--sidebar-bg-color',       '#12111C');
            root.style.setProperty('--sidebar-text-color',     '#ffffff');
            root.style.setProperty('--bg-color',               '#F4F5F7');
        ...
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        primary: {
                            50: 'var(--primary-color-light)',
                            100: 'var(--primary-color-light)',
                            200: 'var(--primary-color-light)',
                            300: 'var(--primary-color-light)',
                            400: 'var(--primary-color-light)',
                        ...
                        secondary: {
                            50: 'var(--secondary-color-light)',
                            100: 'var(--secondary-color-light)',
                            200: 'var(--secondary-color-light)',
                            300: 'var(--secondary-color-light)',
                            400: 'var(--secondary-color-light)',
                            500: 'var(--secondary-color)',
                            600: 'var(--secondary-color)',
                            700: 'var(--secondary-color-dark)',
                            800: 'var(--secondary-color-dark)',
                            900: 'var(--secondary-color-dark)',
                        },
                        accent: {
                            50: '#fdf2f8',
                            100: '#fce7f3',
    ...
    <!-- AMHSRC Chinese Banking Theme — loads LAST to win over all DB styles -->
    ...
    <div class="page-loading active">
        <div class="page-loading-inner">
            <div class="loading-container">
                ...
                <div class="text">AMHSRC &nbsp; 国际商业银行</div>
            </div>
        </div>
    </div>
    ...
    <div class="flex h-screen overflow-hidden" x-data="{sidebarOpen: false, mobileMenuOpen: false, userDropdownOpen: false, notificationsOpen: false}">
        ...
        <div class="hidden md:flex md:w-64 md:flex-col bg-white h-full border-r border-gray-200 shadow-sm">
            <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto">
                <!-- Logo -->
                <div style="padding:18px 16px 14px; border-bottom:1px solid rgba(212,175,55,0.15); margin-bottom:6px;">
                    <a href="/" class="flex items-center space-x-3">
                        <img src="{{ asset('images/amhsrc-logo.svg') }}" alt="AMHSRC" style="height:42px;width:42px;flex-shrink:0;">
                        <div>
                            <div style="font-family:'Inter',sans-serif;font-size:14px;font-weight:800;color:#fff;letter-spacing:0.08em;line-height:1.1;">AMHSRC</div>
                            <div style="font-family:'Noto Serif SC',serif;font-size:9.5px;color:rgba(212,175,55,0.8);letter-spacing:0.06em;line-height:1.4;">国际商业银行</div>
                        </div>
                    </a>
                </div>
        ...
        <p class="text-xs text-gray-500 truncate">
            ID: {{ Auth::user()->usernumber }}
                ...
                <nav class="flex-1 px-4 space-y-1">
                    <p class="px-3 text-xs font-semibold uppercase tracking-wider mt-6 mb-2" style="color:rgba(212,175,55,0.5);font-size:0.62rem;letter-spacing:0.12em;">主菜单 &nbsp;·&nbsp; Main Menu</p>
                    ...
                    <p class="px-3 text-xs font-semibold uppercase tracking-wider mt-6 mb-2" style="color:rgba(212,175,55,0.5);font-size:0.62rem;letter-spacing:0.12em;">转账 &nbsp;·&nbsp; Transfers</p>
                    ...
                    <p class="px-3 text-xs font-semibold uppercase tracking-wider mt-6 mb-2" style="color:rgba(212,175,55,0.5);font-size:0.62rem;letter-spacing:0.12em;">服务 &nbsp;·&nbsp; Services</p>
                    ...
                    <p class="px-3 text-xs font-semibold uppercase tracking-wider mt-6 mb-2" style="color:rgba(212,175,55,0.5);font-size:0.62rem;letter-spacing:0.12em;">账户 &nbsp;·&nbsp; Account</p>
            ...
            <div class="p-4" style="border-top:1px solid rgba(212,175,55,0.15);">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <i data-lucide="shield-check" class="h-4 w-4 mr-2" style="color:#D4AF37;"></i>
                        <span class="text-xs" style="color:rgba(255,255,255,0.4);">安全银行 &nbsp; Secure</span>
                    </div>
                    <span class="text-xs" style="color:rgba(255,255,255,0.2);">amhsrc.com</span>
                </div>
            </div>
        </div>
            ...
            <header class="bg-white shadow-sm z-20">
                <div class="flex items-center justify-between px-4 py-3">
                    ...
                    <div class="flex items-center md:hidden">
                        ...
                        <a href="/" class="ml-4 flex items-center space-x-2">
                            <img src="{{ asset('images/amhsrc-logo.svg') }}" alt="AMHSRC" style="height:32px;width:32px;">
                            <span style="font-family:'Inter',sans-serif;font-size:13px;font-weight:800;color:#222;letter-spacing:0.06em;">AMHSRC</span>
                        </a>
                    </div>
