...
<style>
    /* AMHSRC Admin Sidebar — Chinese Bank Theme */
    .sidebar { background: #12111C !important; border-right: 1px solid rgba(212,175,55,0.12) !important; }
    .sidebar::before { content:''; display:block; height:3px; background:linear-gradient(90deg,#C8102E,#D4AF37,#C8102E); }
    .sidebar .sidebar-wrapper { background: transparent !important; }
    .sidebar .nav-primary .nav-item a { color: rgba(255,255,255,0.65) !important; transition: all 0.2s ease !important; padding: 10px 16px !important; }
    .sidebar .nav-primary .nav-item a:hover { background: rgba(200,16,46,0.12) !important; color: #fff !important; }
    .sidebar .nav-primary .nav-item a:hover i, .sidebar .nav-primary .nav-item a:hover .fas, .sidebar .nav-primary .nav-item a:hover .fa { color: #D4AF37 !important; }
    .sidebar .nav-primary .nav-item.active > a { background: rgba(200,16,46,0.18) !important; color: #fff !important; border-left: 3px solid #C8102E !important; }
    .sidebar .nav-primary .nav-item.active > a i, .sidebar .nav-primary .nav-item.active > a .fas, .sidebar .nav-primary .nav-item.active > a .fa { color: #D4AF37 !important; }
    .sidebar .nav-primary .nav-item a i, .sidebar .nav-primary .nav-item a .fas, .sidebar .nav-primary .nav-item a .fa { color: rgba(255,255,255,0.35) !important; }
    .sidebar .nav-primary p { color: rgba(255,255,255,0.65) !important; font-size: 13px !important; }
    .sidebar .user { border-bottom: 1px solid rgba(212,175,55,0.12) !important; padding: 16px !important; }
    .sidebar .user .info a span { color: #fff !important; font-weight: 600 !important; font-size: 14px !important; }
    .sidebar .user-level { color: rgba(212,175,55,0.75) !important; font-size: 10px !important; text-transform: uppercase !important; letter-spacing: 0.08em !important; }
    .sidebar .nav-collapse { background: rgba(0,0,0,0.15) !important; }
    .sidebar .nav-collapse li a { color: rgba(255,255,255,0.5) !important; padding-left: 40px !important; font-size: 12.5px !important; }
    .sidebar .nav-collapse li a:hover { color: #D4AF37 !important; }
    .sidebar .nav-primary .nav-section { color: rgba(212,175,55,0.4) !important; font-size: 10px !important; letter-spacing: 0.1em !important; text-transform: uppercase !important; padding: 12px 16px 4px !important; }
    .scrollbar-inner { background: transparent !important; }
</style>
...
<div class="sidebar sidebar-style-2" data-background-color="{{ Auth('admin')->User()->dashboard_style }}">
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <!-- AMHSRC Brand Header in Sidebar -->
            <div style="padding:20px 16px 16px;border-bottom:1px solid rgba(212,175,55,0.12);display:flex;align-items:center;gap:10px;">
                <img src="/images/amhsrc-logo.svg" alt="AMHSRC" style="height:38px;width:38px;flex-shrink:0;">
                <div>
                    ...
                    <div style="font-family:'Noto Serif SC',serif;font-size:9px;color:rgba(212,175,55,0.7);letter-spacing:0.06em;line-height:1.5;">国际商业银行</div>
                </div>
            </div>
            <div class="user">
                <div class="info">
